...
The server refreshes the ledger once at startup and then every hour. It writes API/cache files under `/Data/lucky-draw/cache` and writes the public ledger to `/Data/lucky-draw/lucky-draw-ledger.json`.
